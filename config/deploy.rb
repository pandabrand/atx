...
set :production_assets, [
  ...
  'dist/images/COLLIDE-ATX-square.png',
  'dist/images/COLLIDE-ATX-square@2x.png',
  ...
  'dist/images/COLLIDE-CLEAN-ATX-HORIZONTAL.png',
  'dist/images/COLLIDE-CLEAN-ATX-HORIZONTAL@2x.png',
  'dist/images/collide-travel-footers.png',
  'dist/images/collide-travel-footers@2x.png',
  'dist/images/culture-collide-footers.png',
  'dist/images/culture-collide-footers@2x.png',
  'dist/images/next.png',
  'dist/images/prev.png',
  'dist/images/favicons/android-chrome-192x192.png',
  'dist/images/favicons/apple-touch-icon.png',
  'dist/images/favicons/favicon-16x16.png',
  'dist/images/favicons/favicon-32x32.png',
  'dist/images/favicons/favicon.ico',
  'dist/images/favicons/manifest.json',
  'dist/images/favicons/mstile-150x150.png',
  'dist/images/favicons/safari-pinned-tab.svg',
  ...
  'dist/fonts/Montserrat-Regular.otf',
  'dist/fonts/Montserrat-Bold.otf',
  'dist/fonts/slick.eot',
  'dist/fonts/slick.woff',
  'dist/fonts/slick.ttf',
  'dist/fonts/slick.svg'].map {|path| Pathname.new(path) }
